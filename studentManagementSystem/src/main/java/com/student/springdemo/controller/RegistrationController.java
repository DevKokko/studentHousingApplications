...
public class RegistrationController {
	...
	public String processRegistrationForm(
        ...
        Department department = new Department(userName,dep);
        
        Session session = sessionFactory.getCurrentSession();
        
        //session.beginTransaction(); //handled by spring
        session.save(department);
        //session.getTransaction().commit(); //handled by spring
        //session.close(); //handled by spring
